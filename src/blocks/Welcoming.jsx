...
const Welcoming = () => {
    ...
    return (
        <section className="w-100 h-100 container" style={{"paddingTop": "30px"}} name={"Home"}>
            <div className="row w-100 align-items-center">
                ...
                <div className="col-12 col-sm-6 order-3 order-sm-2 d-flex flex-column">
                    <h1 className="home__title">{WelcomeData[0].title}<span
                        className={"home__title-name"}>{WelcomeData[0].title_name}</span>
                    ...
                    <Link to="ContactMe" spy={true} smooth={true} offset={-45} duration={500}
                          className={"w-50 btn bg-primary-color text-primary flex bg-purple-500 text-purple-700 font-semibold py-2 px-4 mt-1 rounded-md"}>Contact
                            Me <UilMessage className="w-5 h-5 ml-2"/>
                    </Link>
                </div>

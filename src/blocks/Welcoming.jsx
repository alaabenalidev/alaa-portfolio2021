...
const Welcoming = () => {
    return (
        ...
        <section className="block w-full h-screen bg-gray-300 grid grid-rows-6">
            <div className="flex row-span-6 gap-y-10 h-screen">
                <div className="flex grid grid-cols-6 gap-x-4">
                    <div className="flex order-1 justify-center items-end lg:items-center col-span-1 ">
                        <div className="block">
                            <a href="" target="_blank" className="text-secondary_color">
                                <UilLinkedinAlt
                                    className="h-6 w-6 sm:h-6 sm:w-6 md:h-7 md:w-7 mx-3 my-3 hover:text-purple-700"/>
                            </a>
                            <a href="" target="_blank" className="text-secondary_color ">
                    ...
                    <div className="flex order-3 lg:order-2 items-center col-span-6 lg:col-span-2 ">
                        <div className="block text-left">
                            <h1 className="text-3xl font-semibold md:text-3xl lg:text-5xl text-primary_color">Hi, I'am Alaa Eddine</h1>
                    ...
                    <div
                        className="flex order-2 lg:order-3 block justify-center items-end lg:items-center col-span-5 lg:col-span-3">
                        <img
                            src={require("../asstes/imgs/background_profile.svg").default}
                            style={{"width": "500px","position":"absolute"}} />
                        <img
                            src={require("../asstes/imgs/DSC_8995_trans.png").default}
